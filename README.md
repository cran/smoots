...
You can install the released version of `smoots` from [CRAN](https://CRAN.R-project.org) with:
...
*y*<sub>*t*</sub> = *m*(*x*<sub>*t*</sub>)+*ξ*<sub>*t*</sub>,

where *t* = 1, …, *n*, *y*<sub>*t*</sub> are the observed values, *x*<sub>*t*</sub> = *t*/*n* are the rescaled observation time points on the closed interval between 0 and 1, *m*(*x*<sub>*t*</sub>) is a smooth trend function and *ξ*<sub>*t*</sub> is a zero-mean stationary error term. The user-friendly and simply applicable function `msmooth()` for the estimation of *m*(*x*<sub>*t*</sub>) in the additive model will be used.
...
results <- msmooth(Yt, p = 1, mu = 1, bStart = 0.1, alg = "A")
...
-   `tsmooth`: Advanced Data-driven Nonparametric Regression for the Trend in Economic Time Series
